...
export class MintrNFT extends ethereum.SmartContract {
  static bind(address: Address): MintrNFT {
    return new MintrNFT("MintrNFT", address);
  }
...
export class PutUpFromSaleCall extends ethereum.Call {
  get inputs(): PutUpFromSaleCall__Inputs {
    return new PutUpFromSaleCall__Inputs(this);
  }

  get outputs(): PutUpFromSaleCall__Outputs {
    return new PutUpFromSaleCall__Outputs(this);
  }
}

export class PutUpFromSaleCall__Inputs {
  _call: PutUpFromSaleCall;

  constructor(call: PutUpFromSaleCall) {
    this._call = call;
  }
...
export class PutUpFromSaleCall__Outputs {
  _call: PutUpFromSaleCall;
